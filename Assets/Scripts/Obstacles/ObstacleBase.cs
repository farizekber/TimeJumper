...
namespace Assets.Scripts
{
    public abstract class ObstacleBase : MonoBehaviour
    {
        ...
        public void Spawn()
        {
            ...
            gobject.transform.localPosition += Global.GlobalObject.transform.localPosition + Global.ForegroundObject.transform.localPosition;
            gobject.transform.parent = Global.ForegroundObject.transform;
        }
